    ...
    def make_instance(self, include_optional) -> ArrayWrapperOfPlayerResponse:
        ...
        if include_optional:
            return ArrayWrapperOfPlayerResponse(
                ...
                results = [
                    dupr_prod.models.player_response.PlayerResponse(
                        age = 55, 
                        ...
                        phone = '+14445785789', 
                        ratings = dupr_prod.models.player_rating_response.PlayerRatingResponse(
                            default_rating = 'DOUBLES', 
                            doubles = '2.864', 
                            doubles_provisional = True, 
                            doubles_reliability_score = 10.0, 
                            doubles_verified = '2.75', 
                            provisional_ratings = dupr_prod.models.provisional_rating.ProvisionalRating(
                        ...
                        registered = True, 
                        registration_details = dupr_prod.models.registration_response.RegistrationResponse(
                        ...
                        sponsor = dupr_prod.models.sponsor_logo_response.SponsorLogoResponse(
                            button_text = '', 
                            description = '', 
                            image_url = '', 
